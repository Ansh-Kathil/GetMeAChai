        ...
        <div className='text-white py-14 container mx-auto '>
            ...
            <div className="social">
                <div className="flex flex-col gap-2 min-h-screen  items-center p-10">
                    ...
                    <button
                        className="flex items-center border w-64 text-black bg-slate-50 border-gray-300 rounded-lg shadow-md max-w-xs px-6 py-2 text-sm font-medium  hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
